...
public class TestsDiffAvgPos extends ApplicationSetupBasedTest {
	...
	public void testPaper() throws Exception {
		...
		DiffAvgPosDsm dsm = new DiffAvgPosDsm();
	...
	public void test1() throws Exception {
		...
		double score = dsm.calculateDependence(ips, new boolean[] { true, true }, new double[] { 1d, 1d }, false);
		assertEquals(2.3333333, score, 0.0001d);
	}
	...
	public void test3() throws Exception {
		Index index = getIndex("b x y z w x y z a");
	...
	public void test5() throws Exception {
		...
		double score = dsm.calculateDependence(ips, new boolean[] { true, true }, new double[] { 1d, 1d }, false);
		assertEquals(0.5, score, 0.0001d);
	}
